...
declare -a langs=("C++" "Java" "Python" "C#" "Javascript" "PHP" "C" 'All')
...
checkpoint_path_last=${code2codesearch_path}codebert_code2code_search_program/All/checkpoint-best-mrr/
...
#    --checkpoint_path=$checkpoint_path_last \
...
python run.py \
    ...
    --do_test \
    --train_data_file=$data_path$lang1/train.jsonl \
    --eval_data_file=$data_path$lang1/test.jsonl \
    --test_data_file=$data_path$lang1/test.jsonl \
    --epoch $NUM_TRAIN_EPOCHS \
    --block_size 512 \
    --train_batch_size $TRAIN_BATCH_SIZE \
